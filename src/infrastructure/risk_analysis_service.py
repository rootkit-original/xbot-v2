...
from ..domain.entities import (
    Position, MarketAnalysis, RiskProfile, RiskLevel, OrderSide, 
    TradingBot, Candle
)
...
class RiskAnalysisService(IRiskAnalysisService):
    ...
    async def _assess_technical_risk(self, analysis: MarketAnalysis) -> Decimal:
        ...
        # Bollinger Bands
        if analysis.bollinger_bands and 'upper' in analysis.bollinger_bands and 'lower' in analysis.bollinger_bands:
    ...
    async def calculate_portfolio_beta(
        self,
        positions: List[Position],
        market_returns: List[Decimal] = None
    ) -> Decimal:
